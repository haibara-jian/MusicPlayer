new Vue({
        ...
        return {
            ...
            allSet: {
                ...
                ck: [
                    ...
                    { id: 4, title: '樱花代码', msg: '开启后网页会添加段樱花代码', checked: false, data: '<script src="./assets/js/yinghua.js"></script>' }
                ],
            },
            wy: {
                songList: [
            ...
            config: '<div id="xf-MusicPlayer" data-cdnName="https://music.huiyuan.cn.eu.org"></div>\n<script src="https://music.huiyuan.cn.eu.org/xf-MusicPlayer/js/xf-MusicPlayer.min.js"></script>',
        }
    },
    computed: {
        year() {
    ...
    methods: {
        ...
        form() {
            ...
            this.config = `<div id="xf-MusicPlayer" data-cdnName="https://music.huiyuan.cn.eu.org" ${res}></div>\n<script src="https://music.huiyuan.cn.eu.org/xf-MusicPlayer/js/xf-MusicPlayer.min.js"></script>\n${cherry}`
        },
        postUrl() {
            fetch('/config', {
                method: 'POST',
