...
window.addEventListener('DOMContentLoaded', function () {
    ...
    function customFile() {
        ...
        if (location.protocol === 'file:') {
            xfplayIconCSS = 'https://music.huiyuan.cn.eu.org/xf-MusicPlayer/icon/xfplayIcon.min.css'
            MusicPlayerCSS = 'https://music.huiyuan.cn.eu.org/xf-MusicPlayer/css/xf-MusicPlayer.min.css'
